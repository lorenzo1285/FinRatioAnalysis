"""T019: Liquidity Ratios tool.

Exposes FinRatioAnalysis.liquidity_ratios() as an MCP tool.
"""
...
def finratio_liquidity_ratios(
    ticker: str,
    freq: str = "yearly",
    response_format: str = "json",
) -> Dict[str, Any]:
    """Return liquidity ratios (Current, Quick, Cash, DIR, TIE, TIE_CB, CAPEX_OpCash, OpCashFlow) per reporting period.
