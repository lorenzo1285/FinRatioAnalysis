"""T021: Historical Valuation Metrics tool.

Exposes FinRatioAnalysis.historical_valuation_metrics() as an MCP tool.
"""
...
def finratio_historical_valuation_metrics(
    ticker: str,
    freq: str = "yearly",
    response_format: str = "json",
) -> Dict[str, Any]:
    """Return historical valuation metrics (Market Cap, P/E, EV/EBITDA, FCF Yield) per reporting period.
    ...
    try:
        ...
        df = _call_library(
            ...
            freq=request.freq,
            method_name="historical_valuation_metrics",
        )
