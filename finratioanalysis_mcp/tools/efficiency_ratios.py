"""T017: Efficiency Ratios tool.

Exposes FinRatioAnalysis.efficiency_ratios() as an MCP tool.
"""
...
def finratio_efficiency_ratios(
    ticker: str,
    freq: str = "yearly",
    response_format: str = "json",
) -> Dict[str, Any]:
    """Return efficiency metrics (asset turnover, receivables, inventory, fixed-asset turnover, FCF margin, reinvestment rate) per reporting period.
