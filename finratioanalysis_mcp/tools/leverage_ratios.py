"""T018: Leverage Ratios tool.

Exposes FinRatioAnalysis.leverage_ratios() as an MCP tool.
"""
...
def finratio_leverage_ratios(
    ticker: str,
    freq: str = "yearly",
    response_format: str = "json",
) -> Dict[str, Any]:
    """Return leverage/solvency ratios (Debt/Equity, Equity Ratio, Debt Ratio) per reporting period.
