...
Exposes FinRatioAnalysis.z_score() as an MCP tool.
Note: z_score_plot() is NOT exposed (produces plotly figure, not data).
"""
...
def finratio_z_score(
    ticker: str,
    freq: str = "yearly",
    response_format: str = "json",
) -> Dict[str, Any]:
    """Return the Altman Z-Score and the bankruptcy-risk Zone classification.
