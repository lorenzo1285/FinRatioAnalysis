"""T016: Return Ratios tool.

Exposes FinRatioAnalysis.return_ratios() as an MCP tool.
"""
...
def finratio_return_ratios(
    ticker: str,
    freq: str = "yearly",
    response_format: str = "json",
) -> Dict[str, Any]:
    """Return profitability and return metrics (ROE, ROA, ROCE, ROIC, margins) per reporting period for a ticker. Time-series: one row per period, dates in the 'date' field.
